...
# Formato objeto Manga: name,genres,mangakas,num_vols, puntuacion_media

mangas = [
Manga("One Piece", [Genre.ISEKAI, Genre.SHONEN, Genre.ECCHI], ["Eiichiro Oda"], 12, 8.5),
Manga("Demon Slayer", [Genre.CYBERPUNK,Genre.ISEKAI, Genre.SEINEN], ["Koyoharu Gotouge"], 9, 9.0),
Manga("Bleach Josei", [Genre.JOSEI, Genre.YAOI], ["Ryu Matsumoto"], 13, 7.5),
Manga("Yuri no Yuro", [Genre.YURI, Genre.HENTAI], ["Kikiu Mikoto"], 21, 6.9),
Manga("Glass Mask", [Genre.SPOKON, Genre.SHOJO], ["Suzue Miuchi"], 15, 7.3),
Manga("Maison Ikkoku", [Genre.MECHAS, Genre.SHOJO], ["Rumiko Takahashi"], 5, 8.6),
Manga("The Poe Clan", [Genre.YAOI, Genre.SHONEN], ["Mōto Hagio"], 8, 8.3),
Manga("Star of the Giants", [Genre.SHONEN, Genre.ECCHI], ["Ikki Kajiwara"], 12, 8.1),
Manga("Astro Boy", [Genre.CYBERPUNK,Genre.MAGICAL_GIRLS, Genre.MECHAS], ["Osamu Tezuka"], 15, 7.9),
Manga("Golden Kamuy", [Genre.MECHAS, Genre.YURI], ["Noda Satoru"], 10, 8.0)
]
